...
extension FeedStoreSpecs where Self: XCTestCase {
  func assertThatRetreieveDeliversEtmptyOnEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
  ...
  func assertsThatDeleteDeliversNoErrorOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
    insert((uniqueImageFeed().local, Date()), to: sut)
